...
import SkillUpdate from "../../../components/Modals/Skill/SkillUpdate";
...
import SkillCreate from "../../../components/Modals/Skill/SkillCreate";
...
const SkillList = () => {
  ...
  async function getSkillList() {
    ...
    ApiService.getSkillList(rows, currentPage)
      .then((response) => {
  ...
  const customButton = (rowData) => {
    return (
      <div style={{ display: "flex" }}>
        {/* Update */}
        <SkillUpdate rowData={rowData} refreshList={refreshList} />
      </div>
    );
  };
    ...
    <>
      ...
      <div>
        <div className="d-sm-flex align-items-center justify-content-between mb-4">
          <PageHeading title="Skill List" />
          <SkillCreate refreshList={refreshList} />
        </div>
        {!data ? (
          <p>No data to show...</p>
        ) : (
          ...
          <div className="container-fluid">
            <div className="card shadow mb-4">
              ...
              >
                ...
                <Column header="Name" body={customButton} />
              </DataTable>
              <Paginator
                paginator
                template={template}
